...
const Nav = () => {
  return <>
    <div className='w-[20%] h-full border-r border-zinc-200 p-8  text-white'>
      ...
      <nav className='w-full flex flex-col'>
        <Link className='text-zinc-300 p-5 hover:bg-indigo-700 hover:text-zinc-50 rounded-lg duration-150 '><i className="ri-information-fill text-yellow-300"></i> About SareGama</Link>
